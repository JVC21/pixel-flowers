    ...
    return (
        ...
        >
            <div className="lg:min-w-54 xl:min-w-60">
                <h2 className="cal-sans-regular text-body text-4xl tracking-wide mb-2">{flower.common_name ?? "Unknown"}</h2>
                <p className="outfit-regular-italic text-muted text-sm mb-6 xl:mb-8">{flower.scientific_name ?? "No scientific name"}</p>
                <p className="outfit-regular text-body text-justify">{flower.description ?? "No description available"}</p>
            </div>
            <div>
                <p className="dm-mono-medium-italic text-strong text-xs text-right">{flower.date_added ?? "Unknown date"}</p>
